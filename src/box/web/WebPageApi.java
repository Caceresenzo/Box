...
public class WebPageApi implements WebPage {
	...
	@Override
	public String writePageContent(WebSite webSite, Matcher uriMatcher, HttpConnection connection, HttpRequest request,
			HttpResponse response) {
		return apiManager.handleConnection(webSite, uriMatcher, connection, request, response);
	}
