...
public class WebServer extends HttpWebServer {
	...
	@Override
	public void handleConnection(HttpRequest request, HttpResponse response) throws IOException {
		HttpResponseHeader responseHeader = response.getHeader();
		responseHeader.set("Server", "TheBox v" + TheBox.VERSION);

		String requestUri = request.getRequestedUri();
		if (requestUri.isEmpty() || requestUri.equals("/")) {

			StringBuilder builder = new StringBuilder();
			builder.append("<html>");
			builder.append("<head>");
			builder.append("<title>TheBox</title>");
			builder.append(
			...
			builder.append("<style>").append("").append("</style>");
			builder.append("<script>").append("").append("</script>");
			builder.append("<head>");
			builder.append("<body>");
			...
			responseHeader.setContentType("text/html", StandardCharsets.UTF_8);
		} else if (requestUri.startsWith("/api")) {

			responseHeader.setContentType("application/json", StandardCharsets.UTF_8);
			...
			response.setContent(HtmlUtils.createDefaultPage(HttpStatusCode.CLIENT_ERROR_NOT_FOUND));
	}
