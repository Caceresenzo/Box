...
public class WebServer extends HttpWebServer {
	...
	public void handleConnection(HttpRequest httpRequest, HttpResponse httpResponse) throws IOException {
		...
		if (requestUri.isEmpty() || requestUri.equals("/")) {
			...
			httpResponse.setContent(HtmlUtils.generatePage(HttpStatusCode.CLIENT_ERROR_NOT_FOUND));
	}
